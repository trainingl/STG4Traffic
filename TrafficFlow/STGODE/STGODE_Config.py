...
args.add_argument('--sigma1', default=config['data']['sigma1'], type=float)
args.add_argument('--sigma2', default=config['data']['sigma2'], type=float)
args.add_argument('--thres1', default=config['data']['thres1'], type=float)
args.add_argument('--thres2', default=config['data']['thres2'], type=float)
