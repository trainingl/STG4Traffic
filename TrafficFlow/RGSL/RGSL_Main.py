...
from model.RGSL.rgsl import RGSL as Network
...
def load_data(args):
    train_dataloader, val_dataloader, test_dataloader, scaler = get_dataloader(args, 
                                                                            ...
                                                                            dow=False, 
                                                                            single=False)
    adj_mx, _ = get_adjacency_matrix(args.graph_path, args.num_node, args.filename_id)
...
if __name__ == '__main__':
    ...
    if args.mode == "train":
        ...
        checkpoint = "../log/RGSL/PEMSD4/20221207215901/PEMSD4_RGSL_best_model.pth"
