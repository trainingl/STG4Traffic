...
args.add_argument('--l2lambda', default=config['train']['l2lambda'], type=eval)
# 4. model params
...
args.add_argument('--pre_k', default=config['model']['pre_k'], type=eval)
args.add_argument('--pre_v', default=config['model']['pre_v'], type=eval)
