...
# 4. model params
args.add_argument('--type', default=config['model']['type'], type=eval)
args.add_argument('--g_type', default=config['model']['g_type'], type=eval)
...
args.add_argument('--hid_dim', default=config['model']['hid_dim'], type=eval)
args.add_argument('--hid_hid_dim', default=config['model']['hid_hid_dim'], type=eval)
args.add_argument('--num_layers', default=config['model']['num_layers'], type=eval)
args.add_argument('--cheb_order', default=config['model']['cheb_order'], type=eval)
args.add_argument('--model_type', default=config['model']['model_type'], type=eval)
args.add_argument('--solver', default=config['model']['solver'], type=eval)
